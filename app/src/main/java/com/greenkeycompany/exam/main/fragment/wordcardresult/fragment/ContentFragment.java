    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        switch (trainingType) {
            case WORD_CARD_SET_TRAINING: {
                view = inflater.inflate(R.layout.word_card_result_word_card_set_training, container, false);
            ...
            break;
            case RULE_EXAM: {
                view = inflater.inflate(R.layout.word_card_result_exam, container, false);
            ...
            case FINAL_EXAM:
                ...
                FinalExamResult result = realmRepository.getFinalExamResult(resultId);
                FinalExamResult bestResult = realmRepository.getBestFinalExamResult();
